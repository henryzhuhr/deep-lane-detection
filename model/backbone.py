...
class resnet(torch.nn.Module):
    def __init__(self,layers,pretrained = False):
        ...
        if layers == '18':
            ...
            model = torchvision.models.resnext101_32x8d(weights=torchvision.models.ResNeXt101_32X8D_Weights.DEFAULT)
        elif layers == '50wide':
            model = torchvision.models.wide_resnet50_2(weights=torchvision.models.Wide_ResNet50_2_Weights.DEFAULT)
        elif layers == '101wide':
            model = torchvision.models.wide_resnet101_2(weights=torchvision.models.Wide_ResNet101_2_Weights.DEFAULT)
        else:
